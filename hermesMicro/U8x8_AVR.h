...
static uint8_t U8x8_AVR_TWI( u8x8_t* u8x8, uint8_t Message, uint8_t ArgumentCount, void* Arguments)
{
	uint8_t* Data;
...
static uint8_t u8x8_avr_delay( u8x8_t * u8x8, uint8_t Message, uint8_t ArgumentCount, void *Arguments)
{
	switch( Message)
  {
